...
// const live2d_api_prefix = 'http://127.0.0.1/asset/src/'; // 本地 demo 测试使用
const live2d_api_prefix = 'https://koader.top/Blog/asset/src/';
// 同时需要引入的 css
// const live2d_waifu_css = ['/home/live2d/waifu.css'];
// const live2d_waifu_css = ['http://127.0.0.1/asset/src/waifu.css'];
const live2d_waifu_css = ['https://koader.top/Blog/asset/src/waifu.css'];

// 需要引入的 js 文件，无需手动添加 Jquery 因为后面会自动检测并添加
// const live2d_waifu_js = ['/home/live2d/live2d.min.js', '/home/live2d/waifu-tips.js']
// const live2d_waifu_js = ['http://127.0.0.1/asset/src/live2d.min.js', 'http://127.0.0.1/asset/src/waifu-tips.js'] // 本地 demo 测试使用
const live2d_waifu_js = ['https://koader.top/Blog/asset/src/live2d.min.js', 'https://koader.top/Blog/asset/src/waifu-tips.js']
// live2d 区域的 DOM 代码
